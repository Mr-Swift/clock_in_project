...
public final class DateUtil {
	...
	// 默认显示日期
	public static final String DATA_STR = "yyyyMMdd";
	// 默认显示时间毫秒
	public static final String TIME_STR = "HHmmssSSS";
	...
	public static final  String getTime(){
		SimpleDateFormat format = new SimpleDateFormat(DATATIMEF_STR_MIS);
	 ...
	 */
	public static String date(final LocalDateTime date) {
		return date.format(DateTimeFormatter.ofPattern(PATTERN_YYYYMMDDHHMMSS));
	}
