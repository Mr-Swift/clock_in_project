    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            if (remark == '' || null == remark) {
                ...
                $.ajax({
                    type: "post",
                    url: '<%=request.getContextPath()%>/goOut/add.do',
                    data: {"remark": remark},
                    traditional: true,
                    dataType: "json",
        ...
        function toExe() {
            $("#shadow").table2excel({
                ...
                filename: "外出打卡" + new Date().getFullYear() + "年" + new Date().getMonth() + 1 + "月" + new Date().getDate() + "日" + ".xls",
                exclude_img: true,
                exclude_links: true,
                exclude_inputs: true
            });
...
<div class="pd-zy20">
    ...
    <div class="cx-bt">
        ...
        <div class="btn-bt">
            <ul>
                <li>
                    <a href="#" onclick="add()">外出打卡</a>
                    <a href="#" onclick="toExe()">导出</a>
                </li>
            </ul>
        </div>
        <!--end-->
        ...
        <div class="search1">
            <ul>
                <form action="<%=request.getContextPath()%>/goOut/toGoOut.do" id="select">
                    ...
                    <li>
                        ...
                        <%--                                   value="${year}-${month}"--%>
                               onclick="WdatePicker({ dateFmt: 'yyyy', maxDate: '%y-%M-%d'})">
                    </li>
                    </li>
                    <li>月：</li>
                    ...
                    <li><select name="remark" id="remark" style="width: 100px">
                        ...
                        <c:forEach items="${remarksList}" var="options" varStatus="optionStatus">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ss_table" style="margin-top:8px;">
        ...
        <c:forEach items="${result.data}" var="info" varStatus="status">
            <tr <c:if test="${status.count%2==0}">class="ol"</c:if>>
                ...
                <td title="${info.clockInName}">${info.clockInName}</td>
