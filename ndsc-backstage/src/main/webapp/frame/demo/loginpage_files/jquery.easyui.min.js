...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combobox","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog"],parse:function(_2){
var aa=[];
...
var form=$(_453);
var cc=["combobox","combobox","combogrid","datetimebox","datebox","combo"];
...
var t=$(_45c);
var _45e=["combo","combobox","combobox","combogrid","slider"];
...
_462.reset();
var t=$(_462);
var _463=["combo","combobox","combobox","combogrid","datebox","datetimebox","spinner","timespinner","numberbox","numberspinner","slider"];
...
}},combobox:{init:function(_68d,_68e){
var _68f=$("<input type=\"text\">").appendTo(_68d);
_68f.combobox(_68e);
return _68f;
},destroy:function(_690){
$(_690).combobox("destroy");
},getValue:function(_691){
var opts=$(_691).combobox("options");
if(opts.multiple){
return $(_691).combobox("getValues").join(opts.separator);
}else{
return $(_691).combobox("getValue");
}
},setValue:function(_692,_693){
var opts=$(_692).combobox("options");
if(opts.multiple){
if(_693){
$(_692).combobox("setValues",_693.split(opts.separator));
}else{
$(_692).combobox("clear");
}
}else{
$(_692).combobox("setValue",_693);
}
},resize:function(_694,_695){
$(_694).combobox("resize",_695);
...
$.data(_8ea,"combobox").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _8ed=$(_8ea).combobox("getValues");
if(opts.multiple){
...
var tree=$.data(_8f8,"combobox").tree;
...
$.fn.combobox=function(_8fa,_8fb){
if(typeof _8fa=="string"){
var _8fc=$.fn.combobox.methods[_8fa];
if(_8fc){
...
_8fa=_8fa||{};
return this.each(function(){
var _8fd=$.data(this,"combobox");
if(_8fd){
$.extend(_8fd.options,_8fa);
}else{
$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_8fa)});
}
_8e9(this);
});
};
...
return $.extend($.data(jq[0],"combobox").options,{originalValue:_8fe.originalValue,disabled:_8fe.disabled,readonly:_8fe.readonly});
},tree:function(jq){
return $.data(jq[0],"combobox").tree;
},loadData:function(jq,data){
return jq.each(function(){
var opts=$.data(this,"combobox").options;
opts.data=data;
var tree=$.data(this,"combobox").tree;
...
$.fn.combobox.parseOptions=function(_901){
return $.extend({},$.fn.combo.parseOptions(_901),$.fn.tree.parseOptions(_901));
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _902(_903){
